...
internal partial class TestEndpoint : ITestEndpoint
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        using var requestMessage = requestFactory
            .FromTemplate("ClientName", "/items/{date}/{optionalDate}")
            .WithPathParameter("date", date.ToString("O"))
            .WithPathParameter("optionalDate", optionalDate?.ToString("O"))
